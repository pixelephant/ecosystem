    ...
    <body id="home">
        <div id="wrapper">
            ...
            <section id="value-prop">
                <h1 class="fadeInDown">Generálkivitelezés</h1>
                <hr class="fadeInDown" />
                <p class="fadeInDown">Generálkivitelezői folyamatmenedzsmentünket több, mint 20 éve csiszoljuk.</p>
                <div class="fadeInDown">
                    <a class="fadeInUp" href="#">referenciák</a>
                    <a class="fadeInUp" href="#">szolgáltatások</a>
                    <a class="fadeInUp" href="#">rólunk</a>
                </div>
            </section>
            <div id="main-content">
                <section id="newest-projects">
                    <hgroup>
                        <h1>Legfrisebb projektek</h1>
                        <hr />
                    </hgroup>
